...
namespace OkamiIndustries
{
	...
	void initButtons()
	{
		...
		CreditsButtons[0].Box = { 0, baseMenu.height,  (float)normalButton.width * CreditsButtons[0].scale, (float)normalButton.height * CreditsButtons[0].scale };
		...
		CreditsButtons[1].Box = { screenWidth - ((float)normalButton.width * OptionsButtons[1].scale),  baseMenu.height,  (float)normalButton.width * CreditsButtons[1].scale, (float)normalButton.height * CreditsButtons[1].scale };
